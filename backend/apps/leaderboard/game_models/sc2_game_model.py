...
class SC2Career(models.Model):
    ...
    highest_1v1_rank = models.CharField()
    highest_team_rank = models.CharField()
...
class Campaign(models.Model):
    ...
    """
    wol = models.CharField()
    hots = models.CharField()
...
class RewardsList(models.Model):
    ...
    """
    selected = models.CommaSeparatedIntegerField()
    earned = models.CommaSeparatedIntegerField()
